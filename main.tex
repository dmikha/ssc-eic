...
\be
\begin{split}
  x'=\Gamma(x-\beta t)&=\Gamma(x-\beta t_{\rm det} -\beta x \cos\theta - \beta(\bm r \bm n_\Omega -x\cos\theta))\\
  &=\frac x\delta - \Gamma\beta t_{\rm det}-\beta(\bm r \bm n_\Omega -x\cos\theta)\,.
\end{split}
\ee
Thus, we obtain the distribution function that describes the production of the emission: 
%
\be
\tilde f(t,\bm r,\bm p) = \frac{\delta^3g(\ve/\delta)}{4\pi \ve^2} \delta(\bm r-\bm r_0)\,,
\ee
%
